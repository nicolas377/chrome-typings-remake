import { RuleCondition } from './declarativeNetRequest';
import { Tab } from './tabs';
import { TAB_ID_NONE } from './tabs';
...
export type RuleCondition = {
   ...
   */
    ...
    /**
     * List of {@link Tab.id} which the rule should not match.
     * An ID of {@link TAB_ID_NONE} excludes requests which don't originate from a tab.
     ...
     * Note: Specifying a {@link RuleCondition.requestMethods} rule condition will also exclude non-HTTP(s) requests,
     * whereas specifying {@link RuleCondition.excludedRequestMethods} will not.
     */
